...
/* RedEye state description variables - one-time shared addresses*/
volatile bool redeye_underline;
volatile bool redeye_wchar;
volatile bool redeye_roman8;
volatile bool redeye_latin1;
volatile bool redeye_linewrap;
volatile bool redeye_error;
volatile bool redeye_busy;
